...
def ejecutar_encontrar_pelicula_mas_larga(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    print("-"*50)
    print("\n\n La pelicula mas larga en minutos es:" +"\n"+("-"*50))
...
def ejecutar_consultar_duracion_promedio_peliculas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    promedio_duracion= mod.duracion_promedio_peliculas(p1, p2, p3, p4, p5)
    print("-"*50)
    print("La duracion promedio de las peliculas es: " + promedio_duracion)
    print("-"*50)
...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    anio = int(input("Digite un año para encontrar la pelicula mas reciente: "))
    pelicula_estreno= mod.encontrar_estrenos(p1, p2, p3, p4, p5, anio)
    print("-"*50)
    print("\n\n Las pelicula(s) estreno son: " +"\n" )
    print(pelicula_estreno["nombre"])
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    conteo_peliculas= mod.cuantas_peliculas_18_mas(p1, p2, p3, p4, p5)
    print("-"*50)
    print("La cantidad de peliculas con clasisficacion 18+ son: ", + conteo_peliculas)
    print("-"*50)
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        hora_nueva = int(input("Ingrese la hora que desea reagendar: "))
        dia_nuevo = input("Ingrese el día que desea reagendar: ")
        control_horario = bool(input("Desea activar el horario de la peliculas ingrese True, sino False: "))
        reagendamiento = mod.reagendar_pelicula(pelicula, hora_nueva, dia_nuevo, control_horario, p1, p2, p3, p4, p5)
        
        if reagendamiento:
            print('La pelicula se puede reagendar.')
        else:
            print('La pelicula no se puede reagendar.')
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        autorizacion = bool(input("Si tiene la autorizacion de sus padres, ingrese True, de lo contrario False: "))
        invitacion = mod.decidir_invitar(pelicula, edad, autorizacion)
        if invitacion:
